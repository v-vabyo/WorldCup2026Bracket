...
const TEAMS = {
  ZAF: { name: "South Africa", code: "ZAF", iso2: "za", group: "A", rating: 70 },
  CAN: { name: "Canada", code: "CAN", iso2: "ca", group: "C", rating: 75 },
  BRA: { name: "Brazil", code: "BRA", iso2: "br", group: "B", rating: 91 },
  JPN: { name: "Japan", code: "JPN", iso2: "jp", group: "E", rating: 79 },
  DEU: { name: "Germany", code: "DEU", iso2: "de", group: "F", rating: 86 },
  PRY: { name: "Paraguay", code: "PRY", iso2: "py", group: "H", rating: 71 },
  NLD: { name: "Netherlands", code: "NLD", iso2: "nl", group: "D", rating: 88 },
  MAR: { name: "Morocco", code: "MAR", iso2: "ma", group: "G", rating: 82 },
  CIV: { name: "Ivory Coast", code: "CIV", iso2: "ci", group: "I", rating: 73 },
  NOR: { name: "Norway", code: "NOR", iso2: "no", group: "K", rating: 74 },
  FRA: { name: "France", code: "FRA", iso2: "fr", group: "D", rating: 93 },
  SWE: { name: "Sweden", code: "SWE", iso2: "se", group: "J", rating: 75 },
  MEX: { name: "Mexico", code: "MEX", iso2: "mx", group: "A", rating: 77 },
  ECU: { name: "Ecuador", code: "ECU", iso2: "ec", group: "L", rating: 76 },
  ENG: { name: "England", code: "ENG", iso2: "gb-eng", group: "B", rating: 90 },
  COD: { name: "DR Congo", code: "COD", iso2: "cd", group: "G", rating: 68 },
  BEL: { name: "Belgium", code: "BEL", iso2: "be", group: "C", rating: 85 },
  SEN: { name: "Senegal", code: "SEN", iso2: "sn", group: "I", rating: 80 },
  USA: { name: "USA", code: "USA", iso2: "us", group: "F", rating: 80 },
  BIH: { name: "Bosnia & Herz.", code: "BIH", iso2: "ba", group: "L", rating: 70 },
  ESP: { name: "Spain", code: "ESP", iso2: "es", group: "E", rating: 89 },
  AUT: { name: "Austria", code: "AUT", iso2: "at", group: "J", rating: 74 },
  PRT: { name: "Portugal", code: "PRT", iso2: "pt", group: "H", rating: 87 },
  HRV: { name: "Croatia", code: "HRV", iso2: "hr", group: "K", rating: 83 },
  CHE: { name: "Switzerland", code: "CHE", iso2: "ch", group: "C", rating: 79 },
  DZA: { name: "Algeria", code: "DZA", iso2: "dz", group: "G", rating: 72 },
  AUS: { name: "Australia", code: "AUS", iso2: "au", group: "B", rating: 76 },
  EGY: { name: "Egypt", code: "EGY", iso2: "eg", group: "F", rating: 72 },
  ARG: { name: "Argentina", code: "ARG", iso2: "ar", group: "A", rating: 94 },
  CPV: { name: "Cape Verde", code: "CPV", iso2: "cv", group: "L", rating: 65 },
  COL: { name: "Colombia", code: "COL", iso2: "co", group: "D", rating: 78 },
  GHA: { name: "Ghana", code: "GHA", iso2: "gh", group: "H", rating: 73 },
};
